...
LIGHTPY_LOGGING_HANDLER = logging.StreamHandler(sys.stderr)
LIGHTPY_LOG = logging.getLogger('LIGHTPY')
LIGHTPY_LOG.setLevel(logging.ERROR)
LIGHTPY_LOG.addHandler(LIGHTPY_LOGGING_HANDLER)
